...
- Create Angular project with ng: `ng new nextech_coding_assignment.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`nextech_coding_assignment.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `nextech_coding_assignment.client.esproj`).
